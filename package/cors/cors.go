...
// CheckCROSAndStepForward enables CORS for requests those match the provided options.
func CheckCROSAndStepForward(opts *Options, res http.ResponseWriter, req *http.Request) bool {
