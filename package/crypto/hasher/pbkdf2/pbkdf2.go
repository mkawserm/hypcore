...
var (
	ErrHashComponentUnreadable = errors.New("crypto/pbkdf2: unreadable component in hashed password")
	ErrHashComponentMismatch   = errors.New("crypto/pbkdf2: hashed password components mismatch")
	ErrAlgorithmMismatch       = errors.New("crypto/pbkdf2: algorithm mismatch")
	ErrSaltContainsDollarSing  = errors.New("crypto/pbkdf2: salt contains dollar sign ($)")
)
